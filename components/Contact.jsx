            ...
            <div className="lg:p-4 h-full ">
              ...
              <div>
                ...
                <p className="py-4">
                  ...
                  Eaque, assumenda repellat saepe, sunt exercitationem soluta
                  architecto quasi incidunt minima laudantium id reiciendis
                  placeat ipsa illo veniam maiores quos sapiente dolore!
                </p>
              </div>
              <div>
                <p className="uppercase pt-8">Hit me up!</p>
